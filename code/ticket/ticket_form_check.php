...
$days_start=$post['day_start'];
$times_start=$post['time_start'];
$times_end=$post['time_end'];
$place_name=$post['place_name'];
$place_address=$post['place_address'];
$sheets_name=$post['sheet_name'];
$sheets_quantity=$post['sheet_quantity'];
$prices=$post['price'];
...
if($okflg==true)
{
  ...
  print '<form method="post" action="ticket_form_done.php">';
